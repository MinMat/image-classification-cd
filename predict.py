...
def main(config):
    ...
    set_trace()
    test_data_loader =  data_loader.tes() 
    ...
    actuals, predictions = test_label_predictions(model, device, data_loader)
    ...
    which_class = 1
    actuals, class_probabilities = test_class_probabilities(model, device, data_loader, which_class)
